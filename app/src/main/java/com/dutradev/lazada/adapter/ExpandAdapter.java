...
public class ExpandAdapter extends BaseExpandableListAdapter {
    Context context;
    List<ProductType> loaiSanPhams;
    ViewHolderMenu viewHolderMenu;

    public ExpandAdapter(Context context, List<ProductType> loaiSanPhams){
    ...
    public View getGroupView(final int vitriGroupCha, boolean isExpanded, View view, ViewGroup viewGroup) {
        ...
        if(viewGroupCha == null){
            ...
            viewGroupCha = layoutInflater.inflate(R.layout.custom_layout_group_parent,viewGroup,false);
