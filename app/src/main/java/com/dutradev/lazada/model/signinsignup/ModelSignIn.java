...
public class ModelSignIn {
    ...
    public String doCachedSignIn(Context context){
        SharedPreferences cachedSingnIn = context.getSharedPreferences("dangnhap",Context.MODE_PRIVATE);
        String tennv = cachedSingnIn.getString("tennv","");

        return tennv;
    }

    public void updateCachedSignIn(Context context, String tenv){
        SharedPreferences cachedSignIn = context.getSharedPreferences("dangnhap",Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = cachedSignIn.edit();
        editor.putString("tennv",tenv);

        editor.commit();
    }

    /*Kiểm tra đăng nhập với cơ sở dữ liệu*/
    public boolean checkSignIn(Context context,String tendangnhap, String matkhau){
        boolean isValid = false;
        String url = HomeActivity.SERVER_NAME;
        ...
        try {
            ...
            if(jsonKetQua.equals("true")){
                ...
                updateCachedSignIn(context,tennv);
    ...
    public GoogleApiClient doGoogleApiClient(Context context, GoogleApiClient.OnConnectionFailedListener failedListener){
    ...
    public GoogleSignInResult doInfoSignInGoogle(GoogleApiClient googleApiClient){
